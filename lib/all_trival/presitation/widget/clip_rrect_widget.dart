                ...
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (_) => SecondScreen(
                              ...
                              borders: widget.list[index].borders.toString(),
                              name: widget.list[index].name!.common.toString(),
                              flags: widget.list[index].flags!.png.toString(),
                              capital: widget.list[index].capital.toString(),
                              fifa: widget.list[index].fifa.toString(),
                              area: widget.list[index].area.toString(),
                              must: widget.list[index].independent.toString(),
